...
//#define UNBAN_GAME_DEL // ðàñêîììåíòèðîâàòü äëÿ óäàëåíèÿ áàíà ïðè ðàçáàíå
#define SET_NAMES_UTF8 // çàêîììåíòèðîâàòü, åñëè ðóññêèå ïðè÷èíû áàíîâ íîðìàëüíî îòîáðàæàëèñü è â ðàííèõ âåðñèÿõ
